...
sudo zypper ref
sudo zypper in -y antigravity git git-lfs handbrake-cli handbrake-gtk papirus-icon-theme firewalld firewall-config helix btop systemd-resolved  zram-generator  systemd-zram-service
